...
processed_transcript = maf[maf['BIOTYPE']=="processed_transcript"]
processed_pseudogene = maf[(maf['BIOTYPE']=="processed_pseudogene")|
                           (maf['BIOTYPE']=="unprocessed_pseudogene")|
                           (maf['BIOTYPE']=="transcribed_unprocessed_pseudogene")]
...
processed_transcript = processed_transcript[processed_transcript['Variant_Classification']=="non_coding_transcript_exon_variant"]
processed_pseudogene = processed_pseudogene[processed_pseudogene['Variant_Classification']=="non_coding_transcript_exon_variant"]
...
processed_transcript_matrix = gener_matrix(processed_transcript)
processed_pseudogene_matrix = gener_matrix(processed_pseudogene)

snp_pro_cod_UTR_matrix.to_csv('snp_pro_cod_UTR_matrix.txt', sep='\t')
snp_pro_cod_updownstream_matrix.to_csv('snp_pro_cod_updownstream_matrix.txt', sep='\t')
snp_pro_cod_upstream_matrix.to_csv('snp_pro_cod_upstream_matrix.txt', sep='\t')
snp_pro_cod_downstream_matrix.to_csv('snp_pro_cod_downstream_matrix.txt', sep='\t')
...
snp_mutation_matrix.to_csv('snp_mutation_matrix.txt', sep='\t')
processed_transcript_matrix.to_csv('processed_transcript_matrix.txt', sep='\t')
processed_pseudogene_matrix.to_csv('pseudogene_matrix.txt', sep='\t')
